/* /home/erika/Música/mpiP-3.4/wrappers.c */
/* DO NOT EDIT -- AUTOMATICALLY GENERATED! */
/* Timestamp: 30 May 2019 10:17  */
/* Location: erikahp240G3 posix */
/* Creator: erika  */
...
static int mpiPif_MPI_Attr_delete( jmp_buf * base_jbuf, MPI_Comm  * comm, int  * keyval)
{
 int rc, enabledState;
 double dur;
 int tsize;
...
static int mpiPif_MPI_Attr_get( jmp_buf * base_jbuf, MPI_Comm  * comm, int  * keyval, void  *attr_value, int  *flag)
{
 int rc, enabledState;
 double dur;
 int tsize;
...
static int mpiPif_MPI_Attr_put( jmp_buf * base_jbuf, MPI_Comm  * comm, int  * keyval, void  *attr_value)
{
 int rc, enabledState;
 double dur;
 int tsize;
...
extern void F77_MPI_FILE_OPEN(MPI_Fint  * comm, mpip_const_char_t  *filename, int  * amode, MPI_Fint  * info, MPI_Fint  *fh , MPI_Fint *ierr) {
int rc;
jmp_buf jbuf;
MPI_Comm c_comm;
MPI_Info c_info;
...
extern void F77_MPI_FILE_SET_VIEW(MPI_Fint  * fh, MPI_Offset  * disp, MPI_Fint  * etype, MPI_Fint  * filetype, mpip_const_char_t  *datarep, MPI_Fint  * info , MPI_Fint *ierr) {
int rc;
jmp_buf jbuf;
MPI_File c_fh;
...
static int mpiPif_MPI_Keyval_create( jmp_buf * base_jbuf, MPI_Copy_function  *copy_fn, MPI_Delete_function  *delete_fn, int  *keyval, void  *extra_state)
{
 int rc, enabledState;
 double dur;
 int tsize;
...
static int mpiPif_MPI_Keyval_free( jmp_buf * base_jbuf, int  *keyval)
{
 int rc, enabledState;
 double dur;
 int tsize;
